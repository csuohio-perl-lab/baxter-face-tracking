// Generated by gencpp from file force_controller/forceControlRequest.msg
// DO NOT EDIT!


#ifndef FORCE_CONTROLLER_MESSAGE_FORCECONTROLREQUEST_H
#define FORCE_CONTROLLER_MESSAGE_FORCECONTROLREQUEST_H
...
struct forceControlRequest_
{
  typedef forceControlRequest_<ContainerAllocator> Type;

  forceControlRequest_()
    : num_ctrls(0)
    , domType()
    , domDes()
    , domGains()
  ...
  forceControlRequest_(const ContainerAllocator& _alloc)
    : num_ctrls(0)
    , domType(_alloc)
    , domDes(_alloc)
    , domGains(_alloc)
  ...
  typedef boost::shared_ptr< ::force_controller::forceControlRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::force_controller::forceControlRequest_<ContainerAllocator> const> ConstPtr;

}; // struct forceControlRequest_

typedef ::force_controller::forceControlRequest_<std::allocator<void> > forceControlRequest;

typedef boost::shared_ptr< ::force_controller::forceControlRequest > forceControlRequestPtr;
typedef boost::shared_ptr< ::force_controller::forceControlRequest const> forceControlRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::force_controller::forceControlRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::force_controller::forceControlRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::force_controller::forceControlRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::force_controller::forceControlRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::force_controller::forceControlRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::force_controller::forceControlRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::force_controller::forceControlRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::force_controller::forceControlRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::force_controller::forceControlRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::force_controller::forceControlRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xcda3fb843d195f1bULL;
  static const uint64_t static_value2 = 0xf40697fef6470230ULL;
};

template<class ContainerAllocator>
struct DataType< ::force_controller::forceControlRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "force_controller/forceControlRequest";
  }
...
template<class ContainerAllocator>
struct Definition< ::force_controller::forceControlRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::force_controller::forceControlRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::force_controller::forceControlRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::force_controller::forceControlRequest_<ContainerAllocator>& v)
  {
    s << indent << "num_ctrls: ";
...
#endif // FORCE_CONTROLLER_MESSAGE_FORCECONTROLREQUEST_H
