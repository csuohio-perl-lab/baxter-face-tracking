...
if("TRUE" STREQUAL "TRUE")
  set(flexbe_states_SOURCE_PREFIX /home/ai05/ros_ws/src/birl_baxter_executive/flexbe_behavior_engine/flexbe_states)
  set(flexbe_states_DEVEL_PREFIX /home/ai05/ros_ws/devel)
  ...
  set(flexbe_states_INSTALL_PREFIX /home/ai05/ros_ws/install)
...
if(NOT "/home/ai05/ros_ws/src/birl_baxter_executive/flexbe_behavior_engine/flexbe_states/src " STREQUAL " ")
  set(flexbe_states_INCLUDE_DIRS "")
  set(_include_dirs "/home/ai05/ros_ws/src/birl_baxter_executive/flexbe_behavior_engine/flexbe_states/src")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'flexbe_states' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Philipp Schillinger <schillinger@sim.tu-darmstadt.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'flexbe_states' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ai05/ros_ws/src/birl_baxter_executive/flexbe_behavior_engine/flexbe_states/${idir}'.  Ask the maintainer 'Philipp Schillinger <schillinger@sim.tu-darmstadt.de>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${flexbe_states_dep}_FOUND)
      find_package(${flexbe_states_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${flexbe_states_dep} REQUIRED ${depend_list})
  endif()
