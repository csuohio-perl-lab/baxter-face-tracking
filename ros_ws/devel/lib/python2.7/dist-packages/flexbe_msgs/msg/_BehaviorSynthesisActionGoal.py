...
string[] sm_outcomes"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.request.name = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.goal.request.system = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.goal.request.goal = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.goal.request.initial_condition = str[start:end].decode('utf-8')
      else:
