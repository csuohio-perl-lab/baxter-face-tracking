...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2IiB.pack(_x.stamp.secs, _x.stamp.nsecs, _x.behavior_id, _x.code))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.stamp.secs, _x.stamp.nsecs, _x.behavior_id, _x.code,) = _struct_2IiB.unpack(str[start:end])
      start = end
      end += 4
