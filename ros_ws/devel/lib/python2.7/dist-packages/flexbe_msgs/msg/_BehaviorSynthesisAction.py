...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.action_result.result.error_code.value))
      ...
      for val1 in self.action_result.result.states:
        ...
        for val2 in val1.parameter_values:
          ...
          if python3:
            ...
            buff.write(struct.pack('<I%ss'%length, length, val2))
        buff.write(_struct_2f.pack(*val1.position))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.request.name = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_goal.goal.request.system = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_goal.goal.request.goal = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_goal.goal.request.initial_condition = str[start:end].decode('utf-8')
      else:
      ...
      (self.action_result.result.error_code.value,) = _struct_i.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.state_path = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          val1.state_class = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          val1.initial_state_name = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          val1.behavior_class = str[start:end].decode('utf-8')
        else:
        ...
        val1.position = _struct_2f.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.outcomes = []
