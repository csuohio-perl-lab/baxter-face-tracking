...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_f.pack(self.field2.field2))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.field2.field4))
      _x = self.field3
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_fd.pack(_x.field4, _x.field5))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.field2.field2,) = _struct_f.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.field2.field4,) = _struct_i.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.field4, _x.field5,) = _struct_fd.unpack(str[start:end])
      return self
