...
echo_and_run cd "/home/ai05/ros_ws/src/birl_baxter_executive/flexbe_behavior_engine/flexbe_input"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/ai05/ros_ws/build/birl_baxter_executive/flexbe_behavior_engine/flexbe_input" \
    install \
    $DESTDIR_ARG \
